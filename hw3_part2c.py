...
df_volume_not_zero = df[df['Volume']!=0]
df_volume_not_zero = df_volume_not_zero[df_volume_not_zero.time[2:] == '59' || df_volume_not_zero.time[2:] == '00']
#print(df_volume_not_zero)
seriesname = 'Open'
series = df_volume_not_zero[seriesname]
drawCharts(series, df_volume_not_zero.size)
seriesname = 'Close'
series = df_volume_not_zero[seriesname]
drawCharts(series, df_volume_not_zero.size)
seriesname = 'High'
